...
write.csv(myfiles_yearly, "E:/Research/Data_pubmed/Plots_data/all_recs_summary.csv")
write.csv(data_affective_yearly, "E:/Research/Data_pubmed/Plots_data/aff_recs_summary.csv")
write.csv(data_cognitive_yearly, "E:/Research/Data_pubmed/Plots_data/cog_recs_summary.csv")
...
png('C:/Users/Rubinzone/Desktop/F1_hires.png', width = 8, height = 12, units = 'in', res = 300)
ggarrange(all, aff, cog,
