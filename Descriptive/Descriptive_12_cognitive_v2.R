...
# D011340 Problem Solving
# D007858 Learning
# D007802 Language
# D001185 Artificial Intelligence
# D003071 Cognition
# D001519 Behavior
# D001921 Brain [REMOVED]


mesh_kyes <- 'D008568|D001288|D010465|D003657|D011340|D007858|D007802|D001185|D003071|D001519'
data_cognitive_major <- dplyr::filter(myfiles, grepl(mesh_kyes, mesh_major_UI, ignore.case = TRUE))
write.csv(data_cognitive_major, "E:/Research/Data_pubmed/cognitive_data/cognitive_major_UI_nobrain.csv")



data_cognitive_major <- read.csv("E:/Research/Data_pubmed/cognitive_data/cognitive_major_UI_nobrain.csv")
remove(myfiles)
...
q + geom_line() +
  ...
  labs(x = NULL, y = "Cognitive publications in PubMed DB (No brain)",
...
write.csv(cognitive_cit_ref, "E:/Research/Data_pubmed/cognitive_data/cognitive_data_cit_ref_data_nobrain.csv")
...
write.csv(cognitive_cit_ref[!is.na(cognitive_cit_ref$references) & !is.na(cognitive_cit_ref$cited_by),]$pmid, "E:/Research/Data_pubmed/cognitive_data/cognitive_balanced_pmid_nobrain.csv")



#---- PART II

cognitive_cit_ref <- read.csv("E:/Research/Data_pubmed/cognitive_data/cognitive_data_cit_ref_data_nobrain.csv")
data_cognitive_major <- read.csv("E:/Research/Data_pubmed/cognitive_data/cognitive_major_UI_nobrain.csv")
...
data_cognitive_subj <- read.csv("E:/Research/Data_pubmed/cognitive_data/cognitive_subjectareas_major_UI_nobrain.csv")
...
write.csv(cog_cit_dat, "E:/Research/Data_pubmed/cognitive_data/cognitive_cit_full_data_nobrain.csv")
write.csv(cog_ref_dat, "E:/Research/Data_pubmed/cognitive_data/cognitive_ref_full_data_nobrain.csv")


# run descriptive.py script to add proper flags
cog_cit_subj <- read.csv("E:/Research/Data_pubmed/cognitive_data/cognitive_cit_full_data_subjectareas_nobrain.csv")
cog_ref_subj <- read.csv("E:/Research/Data_pubmed/cognitive_data/cognitive_ref_full_data_subjectareas_nobrain.csv")
...
cog_cit <- read.csv("E:/Research/Data_pubmed/cognitive_data/cognitive_cit_full_data_nobrain.csv")
cog_ref <- read.csv("E:/Research/Data_pubmed/cognitive_data/cognitive_ref_full_data_nobrain.csv")
...
write.csv(cog_cit_subj, "E:/Research/Data_pubmed/cognitive_data/cognitive_cit_full_plot_nobrain.csv")
write.csv(cog_cit_subj2, "E:/Research/Data_pubmed/cognitive_data/cognitive_cit_full_plot_ext_nobrain.csv")
write.csv(cog_ref_subj, "E:/Research/Data_pubmed/cognitive_data/cognitive_ref_full_plot_nobrain.csv")


cog_cit <- read.csv("E:/Research/Data_pubmed/cognitive_data/cognitive_cit_full_plot_ext_nobrain.csv")
cog_ref <- read.csv("E:/Research/Data_pubmed/cognitive_data/cognitive_ref_full_plot_nobrain.csv")
