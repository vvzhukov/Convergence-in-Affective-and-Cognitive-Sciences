...
remove(cog_cit, cog_ref, cog_cit_nb, cog_ref_nb)
...
cog_ref_summ_nb$total_hits_L1 <- rowSums(cog_ref_summ_nb[,c(10,11,16,18)])
cog_cit_summ_publ_nb$total_hits_L1 <- rowSums(cog_cit_summ_publ_nb[,c(10,11,16,18)])
...
cog_cit_plot_publ_nb <- ggplot(cog_cit_summ_publ_nb, aes(x=yearP)) +
  geom_line(aes(y=D/total_hits_L1, color='D. Drugs/Chemicals'),size=1) +
  geom_line(aes(y=E/total_hits_L1, color='E. Analitycs/Diagnostics'),size=1) +
  geom_line(aes(y=J/total_hits_L1, color='J. Technology/Industry'),size=1) +
  geom_line(aes(y=L/total_hits_L1, color='L. Information Science'),size=1) +
...
cog_ref_plot_nb <- ggplot(cog_ref_summ_nb, aes(x=year)) +
  geom_line(aes(y=D/total_hits_L1, color='D. Drugs/Chemicals'),size=1) +
  geom_line(aes(y=E/total_hits_L1, color='E. Analitycs/Diagnostics'),size=1) +
  geom_line(aes(y=J/total_hits_L1, color='J. Technology/Industry'),size=1) +
  geom_line(aes(y=L/total_hits_L1, color='L. Information Science'),size=1) +
...
png('C:/Users/Rubinzone/Desktop/F4_hires.png', width = 15, height = 8, units = 'in', res = 300)

ggarrange(ref_plot + rremove("x.text") , cog_ref_plot + rremove("x.text") + rremove("y.text"), cog_ref_plot_nb + rremove("x.text") + rremove("y.text"),
          cit_plot_publ, cog_cit_plot_publ + rremove("y.text"), cog_cit_plot_publ_nb + rremove("y.text"),
          ncol = 3, nrow = 2,
          heights = c(1.2,1.2,1.2,1,1,1),
