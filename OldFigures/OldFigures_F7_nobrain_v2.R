...
ggplot(subj_year, aes(x=year)) + 
  geom_line(aes(y=aff_mSA_fDp, color='Affective'),size=2.5)  + 
  geom_line(aes(y=cog_mSA_fDp_nb, color='Cognitive'),size=2.5) +
  ylim(0.25, 0.44) +
  xlim(1967, 2019) +
  theme_bw() +
  ...
  scale_color_manual(name = "",       values = c("Affective" = "darkviolet", 
                                                 "Cognitive" = "grey")) +
