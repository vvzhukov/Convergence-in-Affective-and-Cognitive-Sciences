...
cognitive_data_nb <- subset(cognitive_data, pmid %in% data_cognitive_major_nb$pmid)
cognitive_data_subj_nb <- subset(cognitive_data_subj, pmid %in% data_cognitive_major_nb$pmid)
...
data <- cognitive_data_nb
data_subj <- cognitive_data_subj_nb
