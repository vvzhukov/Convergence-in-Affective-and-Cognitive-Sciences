...
heatmap_func <- function(aff_subj, title_prefix, in_labels, in_size = 4, rem_x_text = FALSE){
...
fig0 <- heatmap_func(aff_subj[aff_subj$pmid %in% affective[affective$year %in% c(1967:2020),2],], "", "1967 - 2019", 6, rem_x_text = FALSE)
...
fig1 <- heatmap_func(aff_subj[aff_subj$pmid %in% affective[affective$year %in% c(1967:1990),2],], "", "1967 - 1990", 6, rem_x_text = TRUE)
fig2 <- heatmap_func(aff_subj[aff_subj$pmid %in% affective[affective$year %in% c(1991:2000),2],], "", "1991 - 2000", 6, rem_x_text = TRUE)
fig3 <- heatmap_func(aff_subj[aff_subj$pmid %in% affective[affective$year %in% c(2001:2010),2],], "", "2001 - 2010", 6, rem_x_text = TRUE)
fig4 <- heatmap_func(aff_subj[aff_subj$pmid %in% affective[affective$year %in% c(2011:2019),2],], "", "2011 - 2019", 6, rem_x_text = FALSE)
